...
public final class NameUtils {
    ...
    public static String[] otherSurnames = {"$", "#", "*"};
    public static String[] onlySurnames = {"董", "孙", ""};
    private static String[] generateSurnames = {"赵", "钱", "孙", "李", "周", "吴", "郑", "王", "明", "方", "许"};

    public static String[] allSurnames = {"赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "褚", "卫", "蒋", "沈", "韩", "杨", "朱", "秦", "尤", "许",
    ...
    public static List<String> getAll() {
        ...
        for (int n = 0; n < allSurnames.length; n++) {
            String name = allSurnames[n];
